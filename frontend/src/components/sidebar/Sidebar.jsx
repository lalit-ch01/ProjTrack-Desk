      ...
      <div id="mobile-sidebar" className={sidebarClasses} style={sidebarStyle}>
        ...
        <div className="d-flex flex-column p-3">
          <ul className="nav nav-pills flex-column mb-auto">
            ...
            {/* Student Activities - for students only */}
            {role === 'student' && (
              <li className="nav-item mb-2">
                <Link
                  to="/my-activities"
            ...
            {/* Project Management - for coordinators ONLY */}
            {role === 'coordinator' && (
              <li className="nav-item mb-2">
                <Link
                  to="/projects"
            ...
            {/* Guide Dashboard - for guides, faculty, and coordinators */}
            {(role === "guide" || role === "faculty" || role === "coordinator") && (
              <li className="nav-item mb-2">
                <Link
                  to="/guide-dashboard"
                  className="nav-link text-dark d-flex align-items-center"
